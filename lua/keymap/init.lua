...
local plug_map = {
    ...
    ["n|<leader>l"] = map_cr("lua vim.lsp.buf.formatting()"):with_noremap():with_silent(),
    ["n|gl"] = map_cr("LSoutlineToggle"):with_noremap():with_silent(),
    ...
    -- ["n|gt"] = map_cr("Lspsaga open_floatterm"):with_noremap():with_silent(),
    ...
    -- Plugin trouble
    ["n|gm"] = map_cr("TroubleToggle"):with_noremap():with_silent(),
    ["n|gM"] = map_cr("TroubleToggle lsp_references"):with_noremap():with_silent(),
    ...
    -- Plugin Telescope
    ["n|<Leader>pp"] = map_cu("lua require('telescope').extensions.project.project{}"):with_noremap():with_silent(),
    ["n|<Leader>pr"] = map_cu("lua require('telescope').extensions.frecency.frecency{}"):with_noremap():with_silent(),
    ["n|<Leader>pe"] = map_cu("Telescope oldfiles"):with_noremap():with_silent(),
    ["n|<Leader>pf"] = map_cu("Telescope find_files"):with_noremap():with_silent(), -- search opend buffer
    -- ["n|<Leader>pc"] = map_cu("Telescope colorscheme"):with_noremap():with_silent(),
    ["n|<Leader>pn"] = map_cu(":enew"):with_noremap():with_silent(),
    ["n|<Leader>ps"] = map_cu("Telescope live_grep"):with_noremap():with_silent(),
    ["n|<Leader>pg"] = map_cu("Telescope git_files"):with_noremap():with_silent(),
    ["n|<Leader>pz"] = map_cu("Telescope zoxide list"):with_noremap():with_silent(),

    -- Plugin Hop
    ["n|<leader>w"] = map_cu("HopChar1CurrentLineAC"):with_noremap(),
    ["n|<leader>b"] = map_cu("HopChar1CurrentLineBC"):with_noremap(),
    ["n|<leader>f"] = map_cu("HopChar2"):with_noremap(),
